    ...
    <div class="container">
        ...
        <div class="controls">
            <div class="sort-buttons">
                <button class="btn btn-primary" onclick="sortBy('updated')">更新日時順</button>
                <button class="btn btn-secondary" onclick="sortBy('skill')">上達度順</button>
                <button class="btn btn-secondary" onclick="sortBy('favorite')">お気に入り優先</button>
            </div>
        ...
        function sortBy(type) {
            ...
            items.sort((a, b) => {
                switch(type) {
                    ...
                    case 'skill':
                        return parseInt(b.dataset.skill) - parseInt(a.dataset.skill);
                    case 'favorite':
                        return parseInt(b.dataset.favorite) - parseInt(a.dataset.favorite);
                    default:
                        return 0;
                }
            });
